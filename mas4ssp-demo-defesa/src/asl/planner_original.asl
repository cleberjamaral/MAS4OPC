...
//Este plano cria a interface gráfica neste caso que faz parte da plataforma JaCaMo
//O agente Planner recebe o produto a ser produzido da interface do usuário
@createGUI	
+!create_GUI : true
 	<-  .print("GUI... selecting the product");
		+product_received([2,6]). //Formato do produto [qual linha usar - list links,tamanho do lote]
